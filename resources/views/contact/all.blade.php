        ...
        <div class="col-sm-8 ">
            ...
            <div class="bg-white rounded col-12 mt-3 p-3 row">
                <div class="overflow-auto col-12 ">
                    <ul class="list-group ">
                        @foreach ($contactAll as $contactAll)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                    @if ($contactAll->photo !== null)
                                        <img src="{{asset('storage') . '/' . $contactAll->photo }}" class="rounded-circle image"  alt="...">
                                        {{ $contactAll->nomContact }}
                                    @else
                                        <img src="{{asset('image/images.png') }}" class="rounded-circle image"  alt="...">
                                        {{ $contactAll->nomContact }}
                                    @endif
                                <a href="{{ route('contct.show', $contactAll->id) }}"><i class="fas fa-info-circle"></i></a>
                                <a href="{{ $contactAll->id }}" style="color: rgb(253, 189, 11)" data-toggle="modal" data-target="#staticBackdropcontact{{ $contactAll->id }}"><i class="fas fa-user-edit"></i></a>
                                <div class="modal fade" id="staticBackdropcontact{{ $contactAll->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel">Modifier le contact</h5>
                                        ...
                                        <div class="modal-body">
                                            <form class="needs-validation"action="{{ route('udatecontact', $contactAll->id) }}" method="POST" novalidate enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom01">nom</label>
                                                        <input type="text" class="form-control col-form-label-sm" name="nom" value="{{ $contactAll->nomContact }}" id="validationCustom01" placeholder="Nom du contact" required>
                                                        <div class="valid-feedback">
                                                        Valide!
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">Prénom</label>
                                                        <input type="text" class="form-control col-form-label-sm" name="prenom" value="{{ $contactAll->prenom }}" id="validationCustom02" placeholder="Prénom du contact" required>
                                                        <div class="valid-feedback">
                                                        Valide!
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">Profession</label>
                                                        <input type="text" class="form-control col-form-label-sm" name="profession" value="{{ $contactAll->profession }}" id="validationCustom02" placeholder="Profession" required>
                                                        <div class="valid-feedback">
                                                        Valide!
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">Téléphone</label>
                                                        <input type="text" class="form-control col-form-label-sm" name="phone" value="{{ $contactAll->phone }}" id="validationCustom02" placeholder="Téléphone" required>
                                                        <div class="valid-feedback">
                                                        Valide!
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">E-mail</label>
                                                        <input type="email" class="form-control col-form-label-sm" name="email" value="{{ $contactAll->email }}" id="validationCustom02" placeholder="E-mail" required>
                                                        <div class="valid-feedback">
                                                        Valide!
                                                        </div>
                                                    </div>
                                ...
                                <a href="{{ route('destroy', $contactAll->id) }}" data-toggle="modal" data-target="#staticBackdropdeletecontact{{  $contactAll->id }}"><i class="far fa-trash-alt" style="color: red;"></i></a>
                                <div class="modal fade" id="staticBackdropdeletecontact{{  $contactAll->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel">Confirmation de la supréssion</h5>
                                        ...
                                        <div class="modal-body">
                                            <p>Cette action suprimera définitivement le contact et elle est irréversible</p>
                                            <a href="{{ route('contact.destroy', $contactAll->id) }}" class="btn btn-danger">Suprimer</a>
                                            <a href="#" class="btn btn-primary" data-dismiss="modal">Annuler</a>
                                        </div>
                                        <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                                ...
                                @if ($contactAll->favoris == 0)
                                    <a href="{{ route('edite', $contactAll->id) }}"><i class="fas fa-heart"></i></a>
                                @else
                                    <a href="{{ route('editefavoris', $contactAll->id) }}"><i class="fas fa-heart" style="color: green;"></i></a>
                                @endif
