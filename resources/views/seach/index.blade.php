...
@section('content')
    ...
    <div class="container row ml-md-5 align-middle">
        ...
        <div class="col-sm-8 ">
            ...
            <div class="bg-white rounded mt-3 p-3 row" style="display: none;">
              <div class="col-sm-4 bg-white rounded shadow">
                ...
                <a href="#" class="btn btn-primary mb-3 btn-sm">Tout afficher</a>
              </div>
              <div class="col-sm-4 bg-white rounded shadow ">
                    <h5 class="mt-3">
            ...
            <div class="bg-white rounded col-12 mt-3 p-3 row">
                <div class="overflow-auto col-12 ">
                    <p>Resutat de la recherche sur <b style="color: red;">{{ $value }}</b></p>
                    <div class="divider mb-3" style="opacity: 0.3;"></div>
                    <ul class="list-group ">
                        <h6><b style="color: red;">{{ $seachContact->count() }}</b> Contact(s) trouvé</h6>
                        @foreach ($seachContact as $seachContact)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                    @if ($seachContact->photo !== null)
                                        <img src="{{asset('storage') . '/' . $seachContact->photo }}" class="rounded-circle image"  alt="...">
                                        {{ $seachContact->nomContact }}
                                    @else
                                        <img src="{{asset('image/images.png') }}" class="rounded-circle image"  alt="...">
                                        {{ $seachContact->nomContact }}
                                    @endif
                                <a href="{{ route('contct.show', $seachContact->id) }}"><i class="fas fa-info-circle"></i></a>
                                <a href="{{ $seachContact->id }}" style="color: rgb(253, 189, 11)" data-toggle="modal" data-target="#staticBackdropcontact{{ $seachContact->id }}"><i class="fas fa-user-edit"></i></a>
                                <div class="modal fade" id="staticBackdropcontact{{ $seachContact->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel">Modifier le contact</h5>
                                        ...
                                        <div class="modal-body">
                                            <form class="needs-validation"action="{{ route('udatecontact', $seachContact->id) }}" method="POST" novalidate enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom01">nom</label>
                                                        <input type="text" class="form-control col-form-label-sm" name="nom" value="{{ $seachContact->nomContact }}" id="validationCustom01" placeholder="Nom du contact" required>
                                                        <div class="valid-feedback">
                                                        Valide!
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">Prénom</label>
                                                        <input type="text" class="form-control col-form-label-sm" name="prenom" value="{{ $seachContact->prenom }}" id="validationCustom02" placeholder="Prénom du contact" required>
                                                        <div class="valid-feedback">
                                                        Valide!
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">Profession</label>
                                                        <input type="text" class="form-control col-form-label-sm" name="profession" value="{{ $seachContact->profession }}" id="validationCustom02" placeholder="Profession" required>
                                                        <div class="valid-feedback">
                                                        Valide!
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">Téléphone</label>
                                                        <input type="text" class="form-control col-form-label-sm" name="phone" value="{{ $seachContact->phone }}" id="validationCustom02" placeholder="Téléphone" required>
                                                        <div class="valid-feedback">
                                                        Valide!
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="validationCustom02">E-mail</label>
                                                        <input type="email" class="form-control col-form-label-sm" name="email" value="{{ $seachContact->email }}" id="validationCustom02" placeholder="E-mail" required>
                                                        <div class="valid-feedback">
                                                        Valide!
                                                        </div>
                                                    </div>
                                ...
                                <a href="{{ route('destroy', $seachContact->id) }}" data-toggle="modal" data-target="#staticBackdropdeletecontact{{  $seachContact->id }}"><i class="far fa-trash-alt" style="color: red;"></i></a>
                                <div class="modal fade" id="staticBackdropdeletecontact{{  $seachContact->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel">Confirmation de la supréssion</h5>
                                        ...
                                        <div class="modal-body">
                                            <p>Cette action suprimera définitivement le contact et elle est irréversible</p>
                                            <a href="{{ route('contact.destroy', $seachContact->id) }}" class="btn btn-danger">Suprimer</a>
                                            <a href="#" class="btn btn-primary" data-dismiss="modal">Annuler</a>
                                        </div>
                                        <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                                ...
                                @if ($seachContact->favoris == 0)
                                    <a href="{{ route('edite', $seachContact->id) }}"><i class="fas fa-heart"></i></a>
                                @else
                                    <a href="{{ route('editefavoris', $seachContact->id) }}"><i class="fas fa-heart" style="color: green;"></i></a>
                                @endif
                    ...
                    <ul class="list-group ">
                        <h6 class="mt-3"><b style="color: red;">{{ $seachGroupe->count() }}</b> groupe(s) trouvé</h6>
                        @foreach ($seachGroupe as $seachGroupe)
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @if ($seachGroupe->image !== null)
                                    <img src="{{asset('storage') . '/' . $seachGroupe->image }}" class="rounded-circle image"  alt="...">
                                    {{ $seachGroupe->nomGroupe }}
                                @else
                                    <img src="{{asset('image/groupe.png') }}" class="rounded-circle image"  alt="...">
                                    {{ $seachGroupe->nomGroupe }}
                                @endif
                                <a href="{{ route('groupe.one', $seachGroupe->id) }}"><span class="badge badge-primary badge-pill"> {{ $seachGroupe->personnels->count() }} Contact(s)</span></a>
                                <a href="{{ route('show', $seachGroupe->id) }}"><i class="fas fa-info-circle"></i></a>
                                <a href="#" style="color: rgb(253, 189, 11);" data-toggle="modal" data-target="#staticBackdropgroupe{{ $seachGroupe->id }}"><i class="fas fa-user-edit"></i></a>
                                <div class="modal fade" id="staticBackdropgroupe{{ $seachGroupe->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel">Modifier le groupe</h5>
                                        ...
                                        <div class="modal-body">
                                            <form class="needs-validation"action="{{ route('groupeupdate', $seachGroupe->id) }}" method="POST" novalidate enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-row">
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationCustom01">nom du groupe</label>
                                                    <input type="text" class="form-control col-form-label-sm" name="nom" id="validationCustom01" value="{{ $seachGroupe->nomGroupe }}" placeholder="Nom du groupe" required>
                                                    <div class="valid-feedback">
                                                    Valide!
                                                    </div>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    <label for="validationCustom01">Description du groupe</label>
                                                    <textarea type="text" class="form-control col-form-label-sm" name="description"  id="validationCustom01" placeholder="Décrivez le groupe" required>{{ $seachGroupe->description }}</textarea>
                                                    <div class="valid-feedback">
                                                    Valide!
                                                    </div>
                                                </div>
                                ...
                                <a href="#" data-toggle="modal" data-target="#staticBackdropdeletegroupe{{ $seachGroupe->id }}"><i class="far fa-trash-alt" style="color: red;"></i></a>
                                <div class="modal fade" id="staticBackdropdeletegroupe{{ $seachGroupe->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        <h5 class="modal-title" id="staticBackdropLabel">Confirmation de la supréssion</h5>
                                        ...
                                        <div class="modal-body">
                                            <p>Cette action néccessite beaucoup votre attention car si cette action est éffectuée vous perdrez tous contacts de ce groupe</p>
                                            <a href="{{ route('destroy', $seachGroupe->id) }}" class="btn btn-danger">Suprimer</a>
                                            <a href="#" class="btn btn-primary">Annuler</a>
                                        </div>
                                        <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
